		...
		<div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
			...
			<div className="space-y-8 text-foreground/80 leading-relaxed">
				<section>
					...
					<p>
						By accessing or using {AppConfig.applicationName}, you agree to be bound by these Legal Terms and
						our Privacy Policy. If you do not agree with any part of these terms, you must not use our
						website.
					</p>
				</section>
				...
				<section>
					...
					<p className="mb-4">
						...
						on {AppConfig.applicationName}&apos;s website for personal, non-commercial transitory viewing
				...
				<section>
					...
					<p>
						The materials on {AppConfig.applicationName}&apos;s website are provided on an &apos;as
				...
				<section>
					...
					<p>
						Subdomains (*.cloudgrids.tech) provided by us are subject to availability and compliance with
						our community guidelines. We reserve the right to revoke subdomain access if it violates our
						terms, hosts malicious content, or acts against our open-source values.
					</p>
				</section>
				...
				<section>
					...
					<p>
						In no event shall {AppConfig.applicationName} or its suppliers be liable for any damages
