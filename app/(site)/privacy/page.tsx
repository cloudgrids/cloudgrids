		...
		<div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
			...
			<div className="space-y-8 text-foreground/80 leading-relaxed">
				<section>
					...
					<p>
						Welcome to {AppConfig.applicationName}. We respect your privacy and are committed to protecting
				...
				<section>
					...
					<ul className="list-disc pl-6 space-y-2">
						...
						<li>
							<strong>Cookies:</strong> We use cookies to enhance your browsing experience and analyze our
							traffic.
						</li>
					</ul>
				</section>
